...
import os
BASE_FOLDER = 'Z:/Analysis/users/Yonit/Movie_Analysis/Labeled_cells/2021_06_21_pos4/Cells/CARE_ensemble/CARE_output/'
...
for folder in DIRS:
    ...
    #    predict_parameters["post_process_algorithm"] = "default (slow/robust) (epyseg pre-trained model only!)" # For final seg
